    ...
    <>
      <PageHero
        ...
        breadcrumb={[
          ...
          { label: c('breadcrumb.temporaire', 'Financement temporaire') },
        ]}
      />
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="bg-accent-50 border-l-4 border-accent-500 p-6 rounded-r-xl mb-10">
            <p className="text-primary-700 font-medium">
              {c('temporaire.bandeau', "Refusé par votre banque ? Besoin de liquidités rapidement ? Faites une demande en ligne — un spécialiste évalue votre dossier dans les 48 heures, sans frais ni engagement.")}
            </p>
          </div>
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            {c('temporaire.intro.p2', "Achat immobilier, refinancement, rénovations majeures, acquisition d'entreprise, financement d'équipements ou transition entre deux hypothèques — si vous détenez de l'équité dans un bien immobilier au Canada, nous pouvons vous aider.")}
          </p>

          <h2 className="font-serif text-2xl font-bold text-primary-700 mb-4 mt-10">
            {c('temporaire.audience.titre', 'À qui s\'adresse le financement temporaire ?')}
          </h2>
          <ul className="space-y-3 text-gray-700 mb-10">
            <li className="flex items-start gap-3">
              <span className="text-accent-500 font-bold">•</span>
              {c('temporaire.audience.1', 'Particuliers avec problèmes de crédit ou faillite antérieure')}
            </li>
            <li className="flex items-start gap-3">
              <span className="text-accent-500 font-bold">•</span>
              {c('temporaire.audience.2', 'Travailleurs autonomes et revenus non traditionnels')}
            </li>
            <li className="flex items-start gap-3">
              <span className="text-accent-500 font-bold">•</span>
              {c('temporaire.audience.3', 'Projets de construction ou de rénovation majeure')}
            </li>
            <li className="flex items-start gap-3">
              <span className="text-accent-500 font-bold">•</span>
              {c('temporaire.audience.4', 'Achat de terrain ou propriété à revenus au Canada')}
            </li>
            <li className="flex items-start gap-3">
              <span className="text-accent-500 font-bold">•</span>
              {c('temporaire.audience.5', "Acquisition d'entreprise ou d'équipements commerciaux")}
            </li>
            <li className="flex items-start gap-3">
              <span className="text-accent-500 font-bold">•</span>
              {c('temporaire.audience.6', 'Transition entre deux hypothèques (prêt pont)')}
            </li>
          </ul>
